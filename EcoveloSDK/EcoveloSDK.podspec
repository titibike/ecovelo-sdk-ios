Pod::Spec.new do |s|
  ...
  DESC
    ...
    # Source = tag git correspondant à s.version
    # (Required for `pod spec lint` / publishing. When used via `:path` in a Podfile,
    # CocoaPods will use the local checkout and ignore this.)
    ...
    # ✅ On distribue le binaire
    s.vendored_frameworks = 'build/EcoveloSDK.xcframework'
