...
var globImport_entry_js = __glob({
  "./pwa-action-sheet.entry.js": () => import("./pwa-action-sheet.entry-FDXWPGC6.js"),
  "./pwa-camera-modal-instance.entry.js": () => import("./pwa-camera-modal-instance.entry-MWM6FJVE.js"),
  "./pwa-camera-modal.entry.js": () => import("./pwa-camera-modal.entry-BO6QDXJP.js"),
  "./pwa-camera.entry.js": () => import("./pwa-camera.entry-XYFR3QWO.js"),
  "./pwa-toast.entry.js": () => import("./pwa-toast.entry-XPASUZ5Z.js")
});
  ...
  if (!hmrVersionId || !BUILD.hotModuleReplacement) {
    ...
    switch (bundleId) {
      case "pwa-action-sheet":
        return import(
          /* webpackMode: "lazy" */
          "./pwa-action-sheet.entry-FDXWPGC6.js"
        ).then(processMod, consoleError);
      case "pwa-camera-modal":
        return import(
          /* webpackMode: "lazy" */
          "./pwa-camera-modal.entry-BO6QDXJP.js"
        ).then(processMod, consoleError);
      case "pwa-toast":
        return import(
          /* webpackMode: "lazy" */
          "./pwa-toast.entry-XPASUZ5Z.js"
        ).then(processMod, consoleError);
      case "pwa-camera-modal-instance":
        return import(
          /* webpackMode: "lazy" */
          "./pwa-camera-modal-instance.entry-MWM6FJVE.js"
        ).then(processMod, consoleError);
      case "pwa-camera":
        return import(
          /* webpackMode: "lazy" */
          "./pwa-camera.entry-XYFR3QWO.js"
        ).then(processMod, consoleError);
    }
  }
